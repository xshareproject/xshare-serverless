...
var transactionDefault : TransactionSchema[] = [
    ...
    {
        "id": "122a5aa3-e4aa-4a57-a420-818fed3060f1",
        "name": "User 4",
        "amount": 12.20,
        "description": "SkipTheDishes 2",
        "createdDate": "July 20th",
        "paymentDate": "August 20th",
        "image": harold,
        "status": PaymentStatus.Pending,
    ...
    {
        "id": "ef0a0809-e563-49eb-a1ac-303a404d83cd",
        "name": "User 5",
        "amount": 45.30,
    ...
    {
        "id": "8558845a-919f-4487-a5e4-19353ab944b5",
        "name": "User 6",
        "amount": 20.00,
        "description": "Bday giftcard 2",
        "createdDate": "July 18",
        "paymentDate": "August 18th",
        "image": harold,
        "status": PaymentStatus.Pending,
    ...
    {
        "id": "122a5aa3-e4aa-4a57-a420-818fed3060f2",
        "name": "User 7",
        "amount": 12.20,
        "description": "SkipTheDishes 3",
        "createdDate": "July 20th",
        "paymentDate": "August 20th",
        "image": harold,
        "status": PaymentStatus.Pending,
    ...
    {
        "id": "ef0a0809-e563-49eb-a1ac-303a404d83ce",
        "name": "User 8",
        "amount": 45.30,
        "description": "Water Bill 3",
        "createdDate": "July 10th",
        "paymentDate": "July 31st",
        "image": harold,
        "status": PaymentStatus.Unpaid,
    ...
    {
        "id": "8558845a-919f-4487-a5e4-19353ab944b6",
        "name": "User 9",
        "amount": 20.00,
        "description": "Bday giftcard 3",
        "createdDate": "July 18",
        "paymentDate": "August 18th",
        "image": harold,
        "status": PaymentStatus.Pending,
